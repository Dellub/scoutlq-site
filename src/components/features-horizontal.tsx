  ...
  return (
    <div ref={ref} className="w-full max-w-6xl mx-auto">
      <div className="">
        ...
        >
          <Accordion.Root
            className="grid md:grid-cols-5 gap-x-10 py-8"
            type="single"
              ...
              >
                ...
                <AccordionTrigger>
                  <div className="flex items-center relative flex-col">
                    <div className="item-box size-16 bg-primary/10 rounded-full flex items-center justify-center [&_svg]:min-h-6 [&_svg]:min-w-6">
                      <item.icon />
                    </div>
