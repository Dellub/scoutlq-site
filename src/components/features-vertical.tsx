...
export function FeaturesVertical({
  ...
  return (
    <div ref={ref} className="max-w-6xl mx-auto">
      <div className="mx-auto h-full grid lg:grid-cols-2 gap-4 md:gap-10 items-center">
        <div
            ...
            {data.map((item, index) => (
              ...
              >
                ...
                <div className="flex items-center relative">
                  <div className="item-box min-w-12 size-12 bg-primary/10 rounded-full sm:mx-6 mx-2 flex items-center justify-center [&_svg]:min-w-6 [&_svg]:min-h-6">
                    <item.icon />
                  </div>

                  <div>
                    <AccordionTrigger className="text-left text-base md:text-xl font-bold pl-0">
                      {item.title}
                    </AccordionTrigger>

                    <AccordionTrigger className="justify-start text-left leading-4 text-sm md:text-base pl-0">
                      {item.description}
                    </AccordionTrigger>
                  </div>
                </div>
